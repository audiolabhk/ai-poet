  ...
  <p>
    An interactive React web app that generates poetry in different styles (Haiku, Sonnet, Poem) using OpenAI's GPT-4 API. Users input a subject, select the poetry type, set temperature for creativity, and receive AI-generated poetic content.
  </p>
